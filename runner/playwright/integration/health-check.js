 ...
 * Health check for TestCraft runner: verifies Node, Playwright, UI and API reachability.
 * Usage: BASE_URL and API_ENDPOINT can be provided via env or defaults will be used.
 *
 * NOTE: This file must be written using a single-quoted here-string in PowerShell
 * to avoid PowerShell variable interpolation which corrupts JS template literals.
 */
